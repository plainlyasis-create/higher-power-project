const traditions = {
  ...
  islam: {
    ...
    media: [
      ...
      "Often associated with political headlines in media"
    ],
    misunderstandings: [
      "Conflated with violence in news media",
  ...
  judaism: {
    ...
    media: [
      ...
      "Represented through symbols rather than form"
    ],
    misunderstandings: [
      "God seen as human-like",
      "Religious law seen as purely restrictive"
    ],
  ...
  christianity: {
    name: "Christianity",
    ultimate: "God (understood through the Trinity)",
    traits: [
    ...
    media: [
      "Often shown as an old man in the sky",
      "Simplified as wish-granting figure"
    ],
    misunderstandings: [
      "God portrayed as human-like",
      "Cultural bias influences depiction"
    ],
  ...
  confucianism: {
    ...
    traits: [
      "Guides ethical relationships",
      "Focus on harmony and society",
      "Impersonal moral structure"
    ],
    media: [
      "Often merged into general 'Eastern philosophy'",
      "Reduced to sayings or wisdom quotes"
    ],
    misunderstandings: [
      "Mistaken as deity-centered religion",
  ...
  sikhism: {
    ...
    traits: [
      ...
      "Living truth through action"
    ],
    media: [
      "Often visually reduced to turbans",
      "Frequently misidentified as other religions"
    ],
    misunderstandings: [
      "Confused with Islam or Hinduism",
      "Core beliefs underrepresented"
    ],
  ...
  taoism: {
    ...
    media: [
      "Aestheticized as 'zen nature philosophy'",
      "Oversimplified as relaxation practice"
    ],
    misunderstandings: [
      "Tao seen as a god-like being",
      "Reduced to meditation aesthetics"
    ],
    tags: ["Impersonal", "Path-based", "Immanent"]
  }
};

function showTradition(key) {
